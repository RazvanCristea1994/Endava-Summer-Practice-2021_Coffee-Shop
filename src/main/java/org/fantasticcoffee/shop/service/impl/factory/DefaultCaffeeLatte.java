...
public class DefaultCaffeeLatte implements StandardCoffeeFactory{

    @Override
    public CustomizableStandardCoffee create(String name, List<ExtraIngredientOnRecipe> extraIngredients) {
        return new CustomizableStandardCoffee(name, StandardCoffee.CAFFEE_LATTE, extraIngredients);
    }
}